<!-- app/Views/content/form_edit_kriteria.php -->
...
<form action="<?= site_url('/update-kriteria/' . $kriteria['id']); ?>" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kode_kriteria" name="kode_kriteria" value="<?= old('kode_kriteria', $kriteria['kode_kriteria']); ?>" placeholder="Masukkan Kode Kriteria" required>
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" value="<?= old('nama', $kriteria['nama']); ?>" placeholder="Masukkan Nama Kriteria" required>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control" id="bobot" name="bobot" value="<?= old('bobot', $kriteria['bobot']); ?>" placeholder="Masukkan Nilai Bobot" required>
